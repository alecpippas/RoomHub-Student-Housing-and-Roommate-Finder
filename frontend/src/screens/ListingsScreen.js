...
function ListingsScreen() {
  ...
  return (
    <Container>
      ...
      {userInfo ? (
        <Button onClick={handleToggleModal}>Create New Listing</Button>
      ) : (
        <></>
      )}
      <Modal
        ...
        <ModalBody style={{ backgroundColor: "#fffaf0" }}>
          <Form onSubmit={submitHandler} style={{ color: "black" }}>
            <Form.Group className="mb-3" controlId="title">
              <Form.Label>
                <i class="fa-solid fa-heading" style={{ color: "#005eff" }}></i>
                &nbsp;Title
              </Form.Label>
              &nbsp;
            ...
            <Row className="mt-3 mb-5">
              <Form.Group className="mb-3" controlId="price" as={Col} md="4">
                <Form.Label>
                  <i
            ...
            <Row className="mb-3">
              ...
              <Form.Group className="mb-3" controlId="bed" as={Col} md="4">
                <Form.Label>
                  <i class="fa-solid fa-bed" style={{ color: "#005eff" }}></i>
                  &nbsp;# of Bedrooms
                </Form.Label>
                &nbsp;
                <i
